            ...
            visitor: {
                CallExpression(ast) {
                    ...
                    if (t.isIdentifier(ast.node.callee, { name: IMPORT_COMPONENT_NAME })) {
                        const pathArg = (0, helper_1.resolveMainFilePath)(node_path_1.default.resolve(node_path_1.default.dirname(id), compiler.resolvePageImportPath(id, t.isStringLiteral(ast.node.arguments[0]) ? ast.node.arguments[0].value : '')));
