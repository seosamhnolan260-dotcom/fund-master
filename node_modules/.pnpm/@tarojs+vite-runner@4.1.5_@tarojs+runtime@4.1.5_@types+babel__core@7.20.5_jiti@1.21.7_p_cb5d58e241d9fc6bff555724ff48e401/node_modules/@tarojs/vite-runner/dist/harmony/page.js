            ...
            if (id.endsWith(exports.PAGE_SUFFIX)) {
                ...
                if (isTabbarPage) {
                    if (tabbarList[0].pagePath === page.name) {
                        ...
                        tabbarPages.forEach((page) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            deps.forEach(dep => {
                                Object.entries(nCompCache.get(dep) || {}).forEach(([key, value]) => {
                                    ...
                                    ncObj[key] = [node_path_1.default.join(node_path_1.default.dirname(node_path_1.default.relative(node_path_1.default.dirname(rawId), absPath)), basename), value[1]];
                                });
                            });
                            if (!page.isNative) {
