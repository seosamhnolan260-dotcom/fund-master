...
var defu = createDefu((obj, key, value) => {
...
function walkAndReplaceValues(options) {
  ...
  root.walkDecls((decl) => {
    ...
    const atRule = rule.parent?.type === "atrule" ? rule.parent : void 0;
    const context = {
      ...baseContext,
      decl,
      rule,
