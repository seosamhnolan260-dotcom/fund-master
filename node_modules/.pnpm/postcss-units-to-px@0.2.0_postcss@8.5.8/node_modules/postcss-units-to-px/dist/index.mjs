import { n as defaultUnitMap, t as defaultOptions } from "./defaults-CKbdHauk.mjs";
...
const plugin = (options = {}) => {
	...
	const mergedUnitMap = userUnitMap === void 0 ? defaultUnitMap : isPlainObject(userUnitMap) ? {
		...defaultUnitMap,
		...userUnitMap
	} : userUnitMap;
